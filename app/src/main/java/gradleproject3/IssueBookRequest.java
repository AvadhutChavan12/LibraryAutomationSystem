 ...
 * @author avadh
 */
public class IssueBookRequest extends javax.swing.JFrame {

    /**
     * Creates new form IssueBookRequest
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssueBookRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IssueBookRequest().setVisible(true);
            }
        });
    }
